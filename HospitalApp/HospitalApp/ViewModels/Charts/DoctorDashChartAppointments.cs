...
public class DoctorDashChartAppointmentsViewModel
{
    ...
    public DoctorDashChartAppointmentsViewModel(int doctorId)
    {
        _doctorId = doctorId;
    ...
    {
        var data = await _apiService.GetNumAppointmentsByDoctor(DateTime.Now.Year, DateTime.Now.Month, _doctorId);
